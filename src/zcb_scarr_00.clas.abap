...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_SCARR_00
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_SCARR_00 .
  types:
...
CLASS ZCB_SCARR_00 IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_CARRID TYPE S_CARR_ID
*      RETURNING RESULT TYPE REF TO ZCL_SCARR_00
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_SCARR_00,
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_SCARR_00.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_SCARR_00.
